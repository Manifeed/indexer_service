...
from app.schemas.indexer_schema import ArticleEmbeddingIndexRead, ArticleThemeRead, SparseEmbeddingRead
...
def test_upsert_article_embedding_includes_language_and_themes(monkeypatch) -> None:
    ...
    assert point["payload"]["themes"] == ["politics"]
