...
from app.clients.database.article_embedding_database_client import replace_article_ner_mentions
from app.schemas.indexer_schema import ArticleNerMentionRead
